...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		...
		self.opacity = 0.7f;
		self.color = nil;
		self.labelFont = [UIFont fontWithName:@"Lato" size:kLabelFontSize];
...
-(void)designCustomView{
        
    customView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, 80, 80)];
    customView.backgroundColor = [UIColor clearColor];
    
    //Rotate
    UIImageView* animatedImageView = [[UIImageView alloc] initWithFrame:CGRectMake(0.0f, 0.0f, 80.0f, 80.0f)];
    
    animatedImageView.image=[UIImage imageNamed:@"ic_loader.png"];
    animatedImageView.contentMode = UIViewContentModeCenter;
    
    CABasicAnimation* rotationAnimation;
    rotationAnimation = [CABasicAnimation animationWithKeyPath:@"transform.rotation.z"];
    rotationAnimation.toValue = [NSNumber numberWithFloat: M_PI * 1.5 * 1* 0.05 ];//M_PI * 2.0 * rotations * duration
    ...
    [animatedImageView.layer addAnimation:rotationAnimation forKey:@"rotationAnimation"];
    ...
    for (int i= 51 ; i < 99; i++) {
        NSString *imageName = [NSString stringWithFormat:@"Loader_00%03d",i ];
        [arrImage addObject:[UIImage imageNamed:imageName]];
    }

    animatedImageView.animationImages = arrImage;
     
     animatedImageView.animationDuration = 1.00f;
     animatedImageView.animationRepeatCount = INFINITY;
     [animatedImageView startAnimating];*/
    
    [customView addSubview:animatedImageView];
}
